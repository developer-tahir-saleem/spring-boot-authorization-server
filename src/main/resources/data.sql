...
INSERT INTO `user` (`id`, `account_non_expired`, `account_non_locked`, `credentials_non_expired`, `enabled`, `password`, `type`, `username`) VALUES
(unhex(replace('d87c8a06-37ec-4d01-b149-8e66f2aa4611','-','')), b'1', b'1', b'1', b'1', '$2a$10$1SPU2i7AcX6m5yyoTTMQwu1hmEdnu0URl//hspiSMhQDYJTQKTpYq', 'OWNER', 'admin@inventoryme.app');
...
(unhex(replace('a21f6182-0d26-11e9-ab14-d663bd873d93','-','')), 'USER'),
(unhex(replace('a21f642a-0d26-11e9-ab14-d663bd873d93','-','')), 'ADMIN'),
(unhex(replace('a21f657e-0d26-11e9-ab14-d663bd873d93','-','')), 'MANAGER'),
(unhex(replace('a21f68da-0d26-11e9-ab14-d663bd873d93','-','')), 'SUPPERVISOR'),
(unhex(replace('a21f6a7e-0d26-11e9-ab14-d663bd873d93','-','')), 'CLIENT'),
(unhex(replace('a21f6bb4-0d26-11e9-ab14-d663bd873d93','-','')), 'WORKER'),
(unhex(replace('a21f6f38-0d26-11e9-ab14-d663bd873d93','-','')), 'ANDROID'),
(unhex(replace('a21f708c-0d26-11e9-ab14-d663bd873d93','-','')), 'IMAWEB'),
(unhex(replace('25c1eac8-0d27-11e9-ab14-d663bd873d93','-','')), 'IMADMIN'),
(unhex(replace('25c1f036-0d27-11e9-ab14-d663bd873d93','-','')), 'IOS');
